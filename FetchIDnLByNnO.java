...
public class FetchIDnLByNnO {
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		if (conn != null) {
			...
			String sql = "select R_ID,R_LENGTH from  river_details WHERE R_NAME='KAVERI' and R_ORIGIN='KODAGU';";
			...
			double R_LENGTH = result.getDouble(2);
